...
namespace Interactions
{
    public class NavigationController : MonoBehaviour, IPointerClickHandler
    {
        ...
        private Coroutine displayMarkerCoroutine;
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (displayMarkerCoroutine != null) StopCoroutine(displayMarkerCoroutine);
            displayMarkerCoroutine = StartCoroutine(DisplayMarker(position, markerHideDelay));
        }
